<?php
	/**
	* This proxy-like file is necessary as GIPOD cannot be accessed with HTTPS. Any cross-origin request from an HTTPS page to HTTP page through XMLHttpRequest gets blocked.
